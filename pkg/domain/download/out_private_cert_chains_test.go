...
func TestOutPrivateCertChainViaHeader(t *testing.T) {
	...
	oneTest(t, service.DownloadPrivateCertChainViaHeader, nil, nil, "test-a", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaHeader, nil, nil, "test-b", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaHeader, nil, nil, "test-c", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaHeader, nil, nil, "test-d", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaHeader, nil, nil, "test-e", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaHeader, nil, nil, "test-g", "", output.ErrJsonUnauthorized)

	// Test: blank/empty apikey provided
	apiKey := ""
	oneTest(t, service.DownloadPrivateCertChainViaHeader, &apiKey, nil, "test-a", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaHeader, &apiKey, nil, "test-b", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaHeader, &apiKey, nil, "test-c", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaHeader, &apiKey, nil, "test-d", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaHeader, &apiKey, nil, "test-e", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaHeader, &apiKey, nil, "test-g", "", output.ErrJsonUnauthorized)
	...
	apiKey = "c-abc.k-123"
	oneTest(t, service.DownloadPrivateCertChainViaHeader, nil, &apiKey, "test-a", "", output.ErrJsonUnauthorized)
	// `b` doesn't have a non-new apikey
	oneTest(t, service.DownloadPrivateCertChainViaHeader, nil, &apiKey, "test-c", "", output.ErrJsonUnauthorized)
	// `d` doesnt have a any correct apikey
	oneTest(t, service.DownloadPrivateCertChainViaHeader, nil, &apiKey, "test-e", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaHeader, nil, &apiKey, "test-g", "", output.ErrJsonUnauthorized)

	// Test: correct new apikey provided but via url
	apiKey = "c-abc-new.k-123-new"
	oneTest(t, service.DownloadPrivateCertChainViaHeader, nil, &apiKey, "test-b", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaHeader, nil, &apiKey, "test-e", "", output.ErrJsonUnauthorized)
...
func TestOutPrivateCertChainViaURL(t *testing.T) {
	...
	// Test: No header provided
	oneTest(t, service.DownloadPrivateCertChainViaUrl, nil, nil, "test-a", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaUrl, nil, nil, "test-b", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaUrl, nil, nil, "test-c", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaUrl, nil, nil, "test-d", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaUrl, nil, nil, "test-e", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaUrl, nil, nil, "test-g", "", output.ErrJsonUnauthorized)

	// Test: blank/empty apikey provided
	apiKey := ""
	oneTest(t, service.DownloadPrivateCertChainViaUrl, nil, &apiKey, "test-a", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaUrl, nil, &apiKey, "test-b", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaUrl, nil, &apiKey, "test-c", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaUrl, nil, &apiKey, "test-d", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaUrl, nil, &apiKey, "test-e", "", output.ErrJsonUnauthorized)
	oneTest(t, service.DownloadPrivateCertChainViaUrl, nil, &apiKey, "test-g", "", output.ErrJsonUnauthorized)
