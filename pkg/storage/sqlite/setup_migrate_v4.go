...
// createDBTablesV4 creates a fresh set of tables in the db using schema version 4
func createDBTablesV4(tx *sql.Tx) error {
	// acme_servers
...
// migrateV2toV3 updates the storage db from user_version 3 to user_version 4, if it cannot
