...
// func (service *Service) SetProviders(w http.ResponseWriter, r *http.Request) error {
...
// 	// save config file
// 	err = service.providers.SaveProvidersConfig(service.app.GetConfigFilename())
// 	if err != nil {
// 		service.logger.Errorf("failed to write lego config file after updating providers (%s), new providers not saved", err)
// 		return output.ErrWriteConfigFailed
// 	}
