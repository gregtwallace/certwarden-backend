...
// and then proceeds.
func (service *Service) Provision(domain, resourceName, resourceContent string, provider providerService) (err error) {
	...
	err = provider.Provision(domain, resourceName, resourceContent)
	if err != nil {
		return err
	}
...
func (service *Service) Deprovision(domain, resourceName, resourceContent string, provider providerService) (err error) {
	...
	err = provider.Deprovision(domain, resourceName, resourceContent)
	if err != nil {
		return err
	}
